        ...
        <div className="text-center">
          ...
          <div className="max-w-3xl mx-auto mb-8">
            <p className="text-lg text-gray-700 leading-relaxed">
              ...
              innovative full-stack solutions. Experienced in building modern web applications using MongoDB, Express.js, 
              React, and Node.js. Seeking challenging opportunities to apply technical expertise and contribute to 
              organizational success through cutting-edge web technologies.
            </p>
          </div>

          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="inline-flex items-center px-6 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-colors shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
